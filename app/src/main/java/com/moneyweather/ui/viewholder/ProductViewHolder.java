...
public class ProductViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private ViewholderProductBinding mBinding;
    private Context mContext;

    private final OnItemClickListener mOnItemClickListener;

    public ProductViewHolder(@NonNull ViewholderProductBinding binding,
    ...
    public void bind(ShopProductItem productItemVO) {
        ...
        mBinding.txtPlaceForSale.setText(productItemVO.getAffiliate());
