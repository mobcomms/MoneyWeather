...
import com.moneyweather.databinding.FragmentThemeSimpleBinding
...
@AndroidEntryPoint
class ThemeSimpleFragment : BaseKotlinFragment<FragmentThemeSimpleBinding, ThemeViewModel>() {
    override val layoutResourceId: Int get() = R.layout.fragment_theme_simple
    ...
    override fun initStartView() {
        FirebaseAnalyticsManager.logEvent(FirebaseAnalytics.Event.SCREEN_VIEW, Bundle().apply {
            putString(FirebaseAnalyticsManager.VIEW_NAME, "락스크린 심플형 테마")
        })

        CommonUtils.setLockScreenSystemBarPaddingAndColor(requireActivity(), viewDataBinding.root, R.color.simple_theme_status_bar_color, true)
...
//                }
    ...
    private fun setWeatherInfo(weather: Weather) {
        viewDataBinding.apply {
            ...
            tvTempDesc.text = weather.lockSimpleWeather()
